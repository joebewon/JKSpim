...
CTLSolve2:
    ...
    CS2N:
        ...
        CS2N_1Pass_OFor:
            ...
            li      $s1, 0                                  # <$s1!> int j = 0;
            CS2N_1Pass_IFor:
                bge     $s1, $s4, CS2N_1Pass_IRof           # if i >= num_cols, goto CS2N_1Pass_IRof
        ...
        CS2N_2Pass_OFor:
            ...
            li      $s1, 0                                  # <$s1!> int j = 0;
            CS2N_2Pass_IFor:
                bge     $s1, $s4, CS2N_2Pass_IRof           # if i >= num_cols, goto CS2N_2Pass_IRof
                ...
                li      $t2, 1                              # $t2 = 1
                sub     $t1, $t2, $t1                       # $t1 = 1 - solution[i][j]
                sb      $t1, 0($t0)                         # solution[i][j] = 1 - solution[i][j];
